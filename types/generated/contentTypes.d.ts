...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    useCases: Attribute.Relation<
      ...
      'api::use-case.use-case'
    >;
    imgBg: Attribute.Media & Attribute.Required;
    logoColor: Attribute.Boolean & Attribute.DefaultTo<false>;
    avis: Attribute.Component<'client.avis'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::client.client',
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contract: Attribute.Enumeration<['CDI', 'Alternance', 'Freelance']> &
      Attribute.Required;
    salaireMin: Attribute.Integer;
    salaireMax: Attribute.Integer;
    description: Attribute.RichText & Attribute.Required;
    candidatures: Attribute.Relation<
      'api::job.job',
      'oneToMany',
      'api::candidature.candidature'
    >;
...
export interface ApiUseCaseUseCase extends Schema.CollectionType {
  ...
  attributes: {
    meta: Attribute.Component<'layout.meta'> & Attribute.Required;
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::use-case.use-case', 'title'> & Attribute.Required;
    thumbnail: Attribute.Media & Attribute.Required;
    mainImg: Attribute.Media & Attribute.Required;
    intro: Attribute.Text & Attribute.Required;
    duration: Attribute.String & Attribute.Required;
    techLever: Attribute.String & Attribute.Required;
    website: Attribute.String;
    context: Attribute.RichText & Attribute.Required;
    needs: Attribute.RichText & Attribute.Required;
    goals: Attribute.Component<'common.texts', true> & Attribute.Required;
    img1: Attribute.Media & Attribute.Required;
    img2: Attribute.Media & Attribute.Required;
    actions: Attribute.RichText & Attribute.Required;
    resultText: Attribute.Text & Attribute.Required;
    results: Attribute.Component<'use-case.big-small-texts', true>;
    ...
    client: Attribute.Relation<
      ...
      'api::client.client'
    >;
    resultDisplayed: Attribute.Component<'use-case.big-small-texts'>;
    imgSite: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
